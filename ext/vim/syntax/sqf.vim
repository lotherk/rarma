...
syn keyword sqfStatement call callExtension camCommand camCommit camCommitPrepared camCommitted
...
syn keyword sqfStatement canUnloadInCombat captive captiveNum catch ceil cheatsEnabled
...
syn keyword sqfStatement commitOverlay compile compileFinal completedFSM composeText configFile configName
...
syn keyword sqfStatement debugFSM debugLog deg deleteCenter deleteCollection
...
syn keyword sqfStatement displaySetEventHandler dissolveTeam distance distributionRegion
...
syn keyword sqfStatement effectiveCommander emptyPositions enableAI enableAttack
...
syn keyword sqfStatement hintSilent htmlLoad image importAllGroups importance in in in
...
syn keyword sqfStatement surfaceIsWater surfaceType switchableUnits switchAction
...
syn keyword sqfStatement textLogFormat tg throw time titleCut titleFadeOut titleObj
...
syn keyword sqfStatement verifySignature viewDistance visibleMap
...
syn keyword sqfStatement waypointType weaponDirection weapons west WFSideText wind
syn keyword sqfStatement worldName worldToModel worldToScreen yes
syn keyword sqfStatement addPrimaryWeaponItem addSecondaryWeaponItem addHandgunItem
syn keyword sqfStatement setScore setRating handgunItems primaryWeaponItems secondaryWeaponItems
syn keyword sqfConditional if then else do while for from to case default switch waitUntil
syn keyword sqfSpecial _this

syn keyword sqfFunction BIS_fnc_taskPatrol BIS_fnc_taskDefend BIS_fnc_MP BIS_fnc_codePerformance
syn keyword sqfFunction Rarma_Kernel_fnc_param Rarma_Kernel_fnc_params
