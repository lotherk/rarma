...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Special", s:hgreen, "", "")
	call <SID>X("PreProc", s:purple, "", "")
	call <SID>X("Operator", s:aqua, "", "bold")
	call <SID>X("Type", s:blue, "", "none")
	call <SID>X("Define", s:purple, "", "none")
	call <SID>X("Include", s:blue, "", "")
    call <SID>X("Label", s:orange, "", "")
    ...
    "sqf syntax highlight
    "call <SID>X("sqfStatement", s:blue, "", "")
    "call <SID>X("sqfString", s:green, "", "")
    "call <SID>X("sqfNumber", s:orange, "", "")
    "call <SID>X("sqfPreProc", s:purple, "", "")
    "call <SID>X("sqfDefine", s:purple, "", "")
    "call <SID>X("sqfInclude", s:purple, "", "")
    "call <SID>X("sqfIncluded", s:purple, "", "")
    "call <SID>X("sqfComment", s:comment, "", "")
    "call <SID>X("sqfCommentL", s:comment, "", "")
    "call <SID>X("sqfLocalVar", s:red, "", "")
    "call <SID>X("sqfOOP", s:orange, "", "")
