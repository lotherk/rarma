#define LOGGER(message) [message, __LINE__, __FILE__, "info"] call Rarma_Logger;
#define LOGGER_WITH_LEVEL(level, message) [message, __LINE__, __FILE__, level] call Rarma_Logger;
